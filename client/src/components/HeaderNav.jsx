...
import { Search, Bell, LogOut, Shield, Edit3, User as UserIcon } from 'lucide-react';
          ...
          {user && (
            <div className="flex items-center space-x-3">
              ...
              <button
                onClick={logout}
                title="Logout"
                className="ml-1 flex items-center space-x-1.5 px-3 py-1.5 text-xs font-medium text-red-600 bg-red-50 hover:bg-red-100 rounded-lg transition-colors border border-red-100"
              >
